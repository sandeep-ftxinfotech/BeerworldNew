            	...
            	<div class="ac-formmain orderformarea">
            		<div class="ac-formbottom">
            			<div class="ac-formbottomarea">
            				<div class="wrap">
            				<h2 class="ac-forminfotitle">Order Form</h2>
            					<form method="post" id="weddingform">
		            				<fieldset>
                                        ...
                                        <button type="button" name="addnew" id="addMoreBeer">Add More Beer</button>
		            					...
		            					<div class="ac-formblock flex-wrapper-tow">
		            						<div class="form-group">
                                                ...
                                                <span>There is delivery fee charged.</span>
	                                        </div><!-- form-group -->
		            					</div><!-- flex-wrapper-three -->
                                        <p class="wo-paskisection">WE HAVE GREAT RATES ON SODA / WATER / ICE <br>
                                        WE HAVE CUSTOM SODA FOR YOUR EVENT. ANY LABEL YOU WOULD LIKE ON SUGAR CANE SODA. PLEASE ASK IF INTERESTED.</p>
		            					<div class="ac-formblock flex-wrapper-three">
		            						<div class="form-group">
                                                <div class="ac-checkbox">
                                                    <div class="checkbox">
                                        ...
                                        <div class="ac-formblock full-input">
                                            <div class="form-group">
                                                <label>Note :</label>
                                                <input type="text" class="textbox validate" name="note">
                                            </div><!-- form-group -->
                                        </div><!-- flex-wrapper-three -->
