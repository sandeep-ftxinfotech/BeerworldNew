            	...
            	<div class="ac-formmain">
            			...
            			<div class="wrap">
            				<div class="ac-formtopinn">
            					<div class="ac-formleft">
		            				...
		            				<div class="ac-btn">
		            					<input type="button" class="button btn-lg" id="fillOnlineForm" value="Fill online form">
		            				</div><!-- ac-btn -->
		            			</div><!-- ac-formleft -->
		            			<div class="ac-formright">
		            				...
		            				<div class="ac-btn">
		            					...
		            					<a href="<?php echo the_permalink(22);  ?>"><input type="button" class="button btn-lg btn-outline" value="Offline Application Form" ></a>
		            				</div><!-- ac-btn -->
		            			</div><!-- ac-formright -->
            				</div><!-- ac-formtopinn -->
            			</div><!-- wrap -->
            		...
            		<div class="ac-formbottom" id="wholeform">
            			<div class="progressbarmain">
            				<ul id="progressbar">
								<li class="active applicantimg">Applicant<br>Information</li>
								<li class="educationimg">Education<br>Information</li>
								<li class="referencesimg">References</li>
								<li class="previousimg">Previous<br>Employment</li>
							</ul>
            			</div><!-- progressbarmain -->
            				...
            				<div class="wrap">
            					<form id="job-application">
		            				<fieldset id="applicationInformation">
		            					<h2 class="ac-forminfotitle">Applicant Information</h2>
		            					...
		            					<div class="ac-btn">
		            						<input type="button" class="button btn-lg btn-outline" value="Next" id="btnNextApplicationInformation">
		            					</div><!-- ac-btn -->
		            				</fieldset>
		            				<fieldset id="educationInformation">
		            					<h2 class="ac-forminfotitle">Education Information</h2>
