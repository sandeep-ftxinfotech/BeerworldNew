...
function offlineApplicationForm()
{
	...
	//$tmp_file		 = date("Y-m-d")."-".date("h-i-s").rand(0,999999999999);
	//$tar_path	     = date("Y-m-d")."-".date("h-i-s").rand(0,999999999999)."-".$_FILES["upload_file"]["name"];
	//$tar_path	     = date("Y-m-d")."-".date("h-i-s").rand(0,999999999999);
	
	$tmp_file		 =  $_FILES["upload_file"]["tmp_name"];
	$tar_path	   =  date("Y-m-d")."-".date("h-i-s").rand(0,999999999999)."-".preg_replace("/[^a-zA-Z0-9.]/", "", $_FILES["upload_file"]["name"]);
